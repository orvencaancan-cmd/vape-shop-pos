...
export default async function PromosPage() {
  ...
  return (
    <main className="animate-fade-in-up mx-auto max-w-2xl px-4 py-8">
      ...
      <h2 className="mt-6 inline-block rounded-full bg-primary px-3 py-1 text-xs font-bold uppercase tracking-wide text-white">
        Loyalty Promo
      </h2>
      ...
      <h2 className="mt-8 inline-block rounded-full bg-primary px-3 py-1 text-xs font-bold uppercase tracking-wide text-white">
        Discount Promo
      </h2>
      <p className="mt-1 text-sm text-muted">
